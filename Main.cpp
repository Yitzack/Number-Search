/*This program finds the self-referential number discribed by Dr. James Grime (@singingbanana). The first digit is the number of 0s, the second is the number of 1s, ... the 10th digit is the number of 9s. I was going to try to make a matrix that desicribed the number meaning that the eigenvectors would be the answer, but I don't think it exists. You could use logic and I immediatly deterimined by proof by contradiction that the first digit can't be 0, otherwise it would be 1. After that, it was more think than I wanted. So I turned to my favorite force, brute force.
